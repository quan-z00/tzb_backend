package com.tzb.backend.aop;

import com.tzb.backend.annotation.ExcludeResultWrapper;
import com.tzb.backend.utils.ResultUtil;
 ...
 * @see com.tzb.backend.annotation.ExcludeResultWrapper 排除结果封装注解，用于指示不对返回结果进行封装。
 * @see com.tzb.backend.utils.ResultUtil 返回结果封装工具类，用于生成封装后的返回结果。
 */
@Aspect
@Component
public class ResultInterceptor {
     ...
     */
    @Pointcut("@within(com.tzb.backend.annotation.ResultWrapper)")
